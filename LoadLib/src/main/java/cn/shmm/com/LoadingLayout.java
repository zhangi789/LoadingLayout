...
public class LoadingLayout extends FrameLayout {
    ...
    private void build() {
        ...
        errorText = MmUtil.findViewById(errorPage, R.id.error_text);
        emptyText = MmUtil.findViewById(emptyPage, R.id.empty_text);
        networkText = MmUtil.findViewById(networkPage, R.id.no_network_text);

        errorImg = MmUtil.findViewById(errorPage, R.id.error_img);
        emptyImg = MmUtil.findViewById(emptyPage, R.id.empty_img);
        networkImg = MmUtil.findViewById(networkPage, R.id.no_network_img);

        errorReloadBtn = MmUtil.findViewById(errorPage, R.id.error_reload_btn);
        networkReloadBtn = MmUtil.findViewById(networkPage, R.id.no_network_reload_btn);
        ...
        errorText.setTextColor(MmUtil.getColor(mContext, tipTextColor));
        emptyText.setTextColor(MmUtil.getColor(mContext, tipTextColor));
        networkText.setTextColor(MmUtil.getColor(mContext, tipTextColor));
        ...
        errorReloadBtn.setTextColor(MmUtil.getColor(mContext, buttonTextColor));
        networkReloadBtn.setTextColor(MmUtil.getColor(mContext, buttonTextColor));

        if (buttonHeight != -1) {

            errorReloadBtn.setHeight(MmUtil.dp2px(mContext, buttonHeight));
            networkReloadBtn.setHeight(MmUtil.dp2px(mContext, buttonHeight));
        }
        if (buttonWidth != -1) {

            errorReloadBtn.setWidth(MmUtil.dp2px(mContext, buttonWidth));
            networkReloadBtn.setWidth(MmUtil.dp2px(mContext, buttonWidth));
        }
    ...
    public LoadingLayout setReloadButtonTextColor(@ColorRes int id) {
        ...
        errorReloadBtn.setTextColor(MmUtil.getColor(mContext, id));
        networkReloadBtn.setTextSize(MmUtil.getColor(mContext, id));
        return this;
    }
